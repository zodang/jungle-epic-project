...
public class CaveRock : MonoBehaviour, IFeatureResetable, IControllable
{
    ...
    private float _lv1Bright = 1.5f;
    private float _lv2Bright = 2.5f;
    ...
    {
        twinkleLv1.SetActive(bright >= _lv1Bright);
        twinkleLv2.SetActive(bright >= _lv2Bright);
    }
